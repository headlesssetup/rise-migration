...
_Last updated: 2026-08-16 (Creator AI-paste flow built on branch `claude/ppt-to-rise-pipeline-7e83fd`, awaiting merge with the other v0.8.0 branch). Keep this current at each phase boundary._

## Creator AI-paste flow — BUILT on `claude/ppt-to-rise-pipeline-7e83fd` (2026-08-16, not yet merged)
